...
- Logging and error handlingpython "c:\Users\HP 1030X360 G2\Documents\Projets Importants\PROJETS POO PYTHON\extractiondeSiteCréationQuestionaire.py" --all-letters --output "c:\Users\HP 1030X360 G2\Documents\Projets Importants\PROJETS POO PYTHON\glossaire_AZ.txt" --format txt --debug
